...
public class OrderControllerImpl implements OrderController {
    ...
    public void create(Context context) {
        ...
        norder.setTransporte(auto1);
        System.out.println(norder.calculaTiempoLlegada());
        
        System.out.println("Log Status Order2");
        OrderedState ordered2 = new OrderedState();
        norder.setState(ordered2);
        norder.nextState();
        norder.printStatus();
        norder.nextState();
        norder.printStatus();
        norder.completeOrder();
        norder.nextState();
        norder.printStatus();
        norder.completeOrder();
        norder.printStatus();
